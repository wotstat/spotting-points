...
class GeometryTests(unittest.TestCase):
    ...
    def test_highlight_groups_only_include_semantic_guides(self):
        ...
        self.assertEqual(len(groups['left']), 5)
        self.assertEqual(groups['left'][1].points, [(-2, 1, -4), (-2, 3, 6)])
        self.assertEqual(groups['left'][2].points, [(-2, 3, -4), (-2, 1, 6)])
        self.assertEqual(groups['left'][3], lines[7])
        self.assertEqual(groups['left'][4].points, [(0, 3.5, 1.8), (-2, 3.5, 1.8)])
        self.assertEqual(len(groups['right']), 5)
        self.assertEqual(groups['right'][1].points, [(2, 1, 6), (2, 3, -4)])
        self.assertEqual(groups['right'][2].points, [(2, 3, 6), (2, 1, -4)])
        self.assertEqual(groups['right'][3].points, [(0, 3.5, 1.8), (2, 3.5, 1.8)])
        self.assertEqual(groups['right'][4], lines[9])
