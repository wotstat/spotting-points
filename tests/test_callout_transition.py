...
from wotstat_spotting_points.callout_transition import CalloutTransitions
...
class CalloutTransitionTests(unittest.TestCase):
    ...
    def test_side_jump_animates_straight_and_finishes_with_cached_input(self):
        ...
        end = renderer.apply({'revision': 1}, 1.2)['placements'][0]
    ...
    def test_continuous_camera_motion_does_not_restart_active_tween(self):
        ...
        self.assertEqual(renderer.apply({'revision': 1}, 1.2)['placements'][0],
                         moved['placements'][0])
    ...
    def test_new_jump_starts_from_current_animated_position(self):
        ...
        self.assertEqual(renderer.apply({'revision': 1}, 1.3)['placements'][0]['rect'][0], 80)
