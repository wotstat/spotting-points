...
Если вращение разрешено, перетаскивание, начатое на башне или орудии, вращает
башню по горизонтали и поднимает/опускает орудие по вертикали. Углы ограничены
...
- «Мир танков»: `dist/wotstat.spotting-points_0.2.0.mtmod` →
  `mods/<версия игры>/`.
- World of Tanks: `dist/wotstat.spotting-points_0.2.0.wotmod` →
  `mods/<версия игры>/`.
