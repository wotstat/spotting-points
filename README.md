...
проекцию башни; верхняя точка занимает место над общим силуэтом машины.
Расположение всех подписей разрешается совместно, поэтому они не перекрывают
друг друга. Сторона и вертикальный порядок меняются только после устойчивого
движения точки, а позиция сноски плавно следует за целью. Боковая линия состоит
из диагонального и короткого горизонтального отрезков. Наведение на маркер или
